...
const serviceProvider_route_1 = __importDefault(require("./provider/serviceProvider.route"));
const admin_route_1 = __importDefault(require("./admin.route"));
const serviceSeeker_route_1 = __importDefault(require("./serviceSeeker.route"));
const business_route_1 = __importDefault(require("./provider/business.route"));
const common_route_1 = __importDefault(require("./common.route"));
const product_route_1 = __importDefault(require("./provider/product.route"));
