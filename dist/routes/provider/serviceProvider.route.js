...
router.post("/onboard/user/profile", multerMiddleware_1.multerMiddleware.single('img'), authMiddleware_1.authServiceProviderMiddleware, multerMiddleware_1.handleMulterError, serviceProvider_controller_1.updateProfile);
// login
