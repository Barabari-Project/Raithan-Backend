...
router.delete("/delete", serviceProvider_controller_1.deleteAccount);
router.get('/products', (0, authMiddleware_1.authMiddleware)(process.env.PROVIDER_JWT_SECRET), serviceProvider_controller_1.getProductsByCategoryAndProivderId);
// profile
router.get('/profile', (0, authMiddleware_1.authMiddleware)(process.env.PROVIDER_JWT_SECRET), serviceProvider_controller_1.profile);
// login
