...
router.get("/products/:category/:status/:businessId", (0, authMiddleware_1.authMiddleware)(process.env.ADMIN_JWT_SECRET), admin_controller_1.getProductByStatusAndProviderId);
