...
MachineProductSchema.post('save', function (error, doc, next) {
    handleMongooseError(error, next);
});
MachineProductSchema.post('findOneAndUpdate', function (error, doc, next) {
    handleMongooseError(error, next);
});
exports.MachineProduct = mongoose_1.default.model('machineProduct', MachineProductSchema, 'machineProduct');
