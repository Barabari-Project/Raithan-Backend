...
import { MechanicServiceType, ProductStatus } from "../../types/product.types";
import createHttpError from "http-errors";
const MechanicProductSchema = new Schema({
    images: {
        type: [String],
...
export const MechanicProduct = mongoose.model('mechanicProduct', MechanicProductSchema, 'mechanicProduct');
