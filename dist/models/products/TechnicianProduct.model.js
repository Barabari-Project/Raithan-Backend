    ...
    services: {
        ...
        validate: {
            validator: function (values) {
                return values.every((value) => Object.values(product_types_1.TechnicianServiceType).includes(value));
            },
...
TechnicianProductSchema.post('save', function (error, doc, next) {
    handleMongooseError(error, next);
});
TechnicianProductSchema.post('findOneAndUpdate', function (error, doc, next) {
    handleMongooseError(error, next);
});
exports.TechnicianProduct = mongoose_1.default.model('technicianProduct', TechnicianProductSchema, 'technicianProduct');
